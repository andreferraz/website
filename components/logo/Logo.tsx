...
import { Circle, Component, Caption, LogoWrapper } from './Logo.styles';
...
export const Logo = ({ className = '' }: Props): JSX.Element => {
	...
	return (
		<Component className={`${className} position-relative d-inline-flex align-items-center`}>
